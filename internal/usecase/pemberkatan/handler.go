...
func NewHandler(r interfaces.PemberkatanRepository, l *logrus.Logger) *handler {
	service := NewPemberkatanServices(&r, l)
	return &handler{
		service: service,
	}
}
